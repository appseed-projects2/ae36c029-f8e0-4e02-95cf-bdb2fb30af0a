...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-16 17:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ae36c029-f8e0-4e02-95cf-bdb2fb30af0a.git
$ cd ae36c029-f8e0-4e02-95cf-bdb2fb30af0a
```
